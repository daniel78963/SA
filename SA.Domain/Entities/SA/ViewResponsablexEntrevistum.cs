...
public partial class ViewResponsablexEntrevistum
{
    ...
    public string? DescripcionRequsito { get; set; }

    public int? RequisitosxProcesoId { get; set; }

    public int? EstadoIdPersxReqxPro { get; set; }
    ...
    public string IdentificacionEnt { get; set; } = null!;
